---
title: "Analytics @ Scale - Redshift"
chapter: true
weight: 17
---

## Analytics @ Scale - Redshift 
...
## Cloud Formation
To launch redshift cluster and configure security automatically using cloud formation, use the following link and skip ahead to [Configure Client Tool](#configure-client-tool).  
[![cloudformation](/image/cloudformation-launch-stack.png)](https://console.aws.amazon.com/cloudformation/home?#/stacks/new?stackName=ImmersionLab1&templateURL=https://s3-us-west-2.amazonaws.com/redshift-immersionday-labs/lab1.yaml)
...
Add Redshift ( Port - 5439 ) with Source - My IP 
To Check your IP use - http://checkip.amazonaws.com/
...
![redshiftClusterRole](/image/redshiftRole.png)
...
* Navigate to [File | Connect Window] to create a new connection profile and modify the following settings and once complete click on the "Test Connection" button.
  ...
  * URL - Find this by navigating to the [Cluster List](https://console.aws.amazon.com/redshiftv2/home?#clusters), selecting your cluster, clicking on **Properties** and copying the **Endpoint** located in the **Connection details**.  
  ![](/image/sqlclinettool2.png)
  * Username - [Master user name]
  * Password - [Master user password]
  * Autocommit - Enabled
![](/image/sqlclinettool3.png)
...
```
```
copy store_sales from 's3://redshift-downloads/TPC-DS/30TB/store_sales/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1';

copy catalog_sales from 's3://redshift-downloads/TPC-DS/30TB/catalog_sales/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy web_sales from 's3://redshift-downloads/TPC-DS/30TB/web_sales/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy web_returns from 's3://redshift-downloads/TPC-DS/30TB/web_returns/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy store_returns from 's3://redshift-downloads/TPC-DS/30TB/store_returns/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy catalog_returns from 's3://redshift-downloads/TPC-DS/30TB/catalog_returns/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy call_center from 's3://redshift-downloads/TPC-DS/30TB/call_center/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy catalog_page from 's3://redshift-downloads/TPC-DS/30TB/catalog_page/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy customer_address from 's3://redshift-downloads/TPC-DS/30TB/customer_address/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy customer from 's3://redshift-downloads/TPC-DS/30TB/customer/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy customer_demographics from 's3://redshift-downloads/TPC-DS/30TB/customer_demographics/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy date_dim from 's3://redshift-downloads/TPC-DS/30TB/date_dim/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy household_demographics from 's3://redshift-downloads/TPC-DS/30TB/household_demographics/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy income_band from 's3://redshift-downloads/TPC-DS/30TB/income_band/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy inventory from 's3://redshift-downloads/TPC-DS/30TB/inventory/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy item from 's3://redshift-downloads/TPC-DS/30TB/item/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy promotion from 's3://redshift-downloads/TPC-DS/30TB/promotion/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy reason from 's3://redshift-downloads/TPC-DS/30TB/reason/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|'  EMPTYASNULL region 'us-east-1' ;

copy ship_mode from 's3://redshift-downloads/TPC-DS/30TB/ship_mode/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL  region 'us-east-1' ;

copy store from 's3://redshift-downloads/TPC-DS/30TB/store/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL region 'us-east-1' ;

copy time_dim from 's3://redshift-downloads/TPC-DS/30TB/time_dim/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL region 'us-east-1' ;

copy warehouse from 's3://redshift-downloads/TPC-DS/30TB/warehouse/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL region 'us-east-1' ;

copy web_page from 's3://redshift-downloads/TPC-DS/30TB/web_page/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL region 'us-east-1' ;

copy web_site from 's3://redshift-downloads/TPC-DS/30TB/web_site/' iam_role 'arn:aws:iam::[Your-AWS_Account_Id]:role/[Your-Redshift-Role]'  gzip delimiter '|' EMPTYASNULL region 'us-east-1' ;
```
...
select count(*) from inventory; -- 1627857000
select count(*) from item; -- 462000
select count(*) from promotion; -- 2300
...
select count(*) from web_returns; -- 2160007345
select count(*) from web_sales; -- 21600036511
select count(*) from web_site; -- 84
```


## Restore 30TB Redshift Cluster from Snapsort

Note - Here we are storing 12 node dc2.8xlarge cluster; so mindful of cost. If you are not using it; please ensure you are deleting or Pausing your cluster. 

```
aws redshift restore-from-cluster-snapshot --cluster-identifier redshift-tpc-ds-30tb --snapshot-identifier redshift-dc2-8xlarge-sep-5-2019 --owner-account 865837280044 --region us-east-1
```

Once cluster is restored - add your redshift IAM role created in prereq section

Redshift Cluster --> Property --> Cluster permissions --> Manage IAM Roles

![Add Redshift IAM Role](/image/addRedshiftRole.png)

![Add Redshift IAM Role 1](/image/addRedshiftRole_1.png)


## Pause Cluster 

Cluster --> Actions --> Pause

![Pause Redshift Cluster](/image/pauseRS.png)